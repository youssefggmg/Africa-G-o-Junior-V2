...
$continatController = new constraint;
if (isset($_GET['id'])) {
    $continant = $continatController->getSinglecontinat($_GET['id']);
}
        ...
        <div class="container-xxl py-5">
            <div class="container-xxl py-5">
                <div class="container">
                    ...
                    <form action="../controller/Modifiecontinant.php" method="POST" class="wow fadeInUp"
                        data-wow-delay="0.2s">
                        <input type="text" hidden value="<?= $continant['continent_id'] ?>" name="CID" class="form-control">

                        <div class="row g-3">
                            <div class="col-md-6">
                                <input type="text" value="<?= $continant['constraintName'] ?>" name="CONname" class="form-control"
                                    placeholder="Nom du Pays" required>
                            </div>
                            <div class="col-md-6">
                                <input type="number" value="<?= $continant['Nmb_payes'] ?>" name="NB_pays"
                                    class="form-control" placeholder="Population" required>
                            </div>
                            <div class="col-12">
                                <input type="text" value="<?= $continant['continentImage'] ?>" name="CONimage" class="form-control"
