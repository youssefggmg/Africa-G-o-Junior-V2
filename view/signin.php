...
<body>
    <div class="flex flex-col justify-center font-[sans-serif] sm:h-screen p-4"
        style="background: linear-gradient(138deg, rgba(212,207,64,1) 6%, rgba(172,170,40,1) 34%, rgba(152,151,28,1) 51%, rgba(120,121,9,1) 75%, rgba(63,76,79,1) 99%)">
        <div class="max-w-md w-full mx-auto border border-gray-300 rounded-2xl p-8 bg-black">
            <div class="text-center mb-12">
                <a href="javascript:void(0)"><img src="../images/logo3.jpg" alt="logo" class='w-40 inline-block' />
                </a>
            </div>
            ...
            <form method="Post" action="../controller/signin.php">
                ...
                <p class="text-gray-800 text-sm mt-6 text-center text-white">you don't an account? <a
                        href="./signup.php" class="text-blue-600 font-semibold hover:underline ml-1">signup here</a></p>
            </form>
        </div>
    </div>
