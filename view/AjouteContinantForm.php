            ...
            <div class="container-xxl py-5">
                <div class="container">
                    <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                        <h6 class="section-title text-center text-primary text-uppercase">Ajouter un continant</h6>
                        <h1 class="mb-5"><span class="text-primary text-uppercase mx-1">Nouveau</span>continant</h1>
                    </div>
                    <form action="../controller/AjoutcontinantController.php" method="POST" class="wow fadeInUp"
                        data-wow-delay="0.2s">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <input type="text" name="CONname" class="form-control" placeholder="Nom du continant"
                                    required>
                            </div>
                            <div class="col-md-6">
                                <input type="number" name="NB_pays" class="form-control"
                                    placeholder="number de pay" required>
                            </div>
                            <div class="col-12">
                                <input type="text" name="CONimage" class="form-control" placeholder="Url de continant">
                            </div>
